            ...
            <div class="row g-0 gy-2 mt-4 align-items-center">
                ...
                <div class="col-xxl-9">
                    <div class="row gy-3 row-cols-9">
                        <div class="col-auto">
                            <img src="<?php echo e($logo . '/' . $settings['home_logo'] . '?' . time()); ?>" alt=""
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled my-3">
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc1" <?php echo e($value->max_users != 0 ? 'checked' : ''); ?>>
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->max_users); ?>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc1" <?php echo e($value->max_employees != 0 ? 'checked' : ''); ?>>
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->max_employees); ?>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc1" <?php echo e($value->storage_limit != 0 ? 'checked' : ''); ?>>
                                            <label class="form-check-label"
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc1" <?php echo e($value->enable_chatgpt != 0 ? 'checked' : ''); ?>>
                                            <label class="form-check-label"
...
<?php /**PATH C:\xampp\htdocs\Alsol\main-file\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>