        ...
        <ul class="dash-navbar">
            ...
            <?php if(\Auth::user()->type == 'employee'): ?>
                <li
                    ...
                    <ul class="dash-submenu">
                        <li class="dash-item <?php echo e(Request::segment(1) == 'setsalary' ? 'active' : '-'); ?>">
                            <a class="dash-link"
                                href="<?php echo e(route('setsalary.show', \Auth::user()->id)); ?>"><?php echo e(__('Salary')); ?></a>
                        </li>
                        <li class="dash-item">
                            <a class="dash-link" href="<?php echo e(route('payslip.index')); ?>"><?php echo e(__('Payslip')); ?></a>
                        </li>
                ...
                <li
                    ...
                    <ul class="dash-submenu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Career')): ?>
                            <li class="dash-item">
                                <a class="dash-link" href="<?php echo e(route('career', [\Auth::user()->creatorId(), 'en'])); ?>"
            ...
            <?php if(\Auth::user()->type == 'super admin'): ?>
                <?php if(Gate::check('Manage Plan')): ?>
                    <li class="dash-item ">
                        <a href="<?php echo e(route('subscrption_plans.index')); ?>" class="dash-link"><span
...
<?php /**PATH C:\xampp\htdocs\Alsol\main-file\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>