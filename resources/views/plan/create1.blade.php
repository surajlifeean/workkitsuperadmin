...
{{ Form::open(['url' => 'subscrption_plans', 'enctype' => 'multipart/form-data']) }}
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::number('offered_price', null, ['class' => 'form-control', 'placeholder' => __('Enter Plan Price')]) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('duration', __('Duration'), ['class' => 'col-form-label']) }}
            {{ Form::number('duration', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Enter duration in months (e.g., 1)']) }}
        </div>
        <div class="form-group col-md-6">
        ...
        {{-- <div class="form-group col-md-6">
            ...
            {{ Form::number('max_employees', null, ['class' => 'form-control', 'required' => 'required', 'readonly' => 'readonly']) }}
            {{-- <span class="small">{{ __('Note: "-1" for Unlimited') }}</span> --}}
        {{-- </div>  --}}
        {{-- <div class="form-group col-md-6">
