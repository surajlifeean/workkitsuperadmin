                    ...
                    <li class="dropdown dash-h-item drp-company">
                        <a class="dash-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <span class="theme-avtar">
                                <img alt="#" src="{{ !empty($users->avatar) ? $profile . $users->avatar : $profile . '/avatar.png' }}" class="header-avtar" style="width: 100%; border-radius:50%">
                            </span>
            ...
            <div class="ms-auto">
                <ul class="list-unstyled">
                    ...
                    <li class="dropdown dash-h-item drp-notification">
                        <a class="dash-head-link dropdown-toggle arrow-none me-0 " id="msg-btn-brodcast"  data-url="{{ route('notifications.create') }}" data-ajax-popup="true" data-title="{{ __('Brodcust') }}" data-size="md" data-bs-toggle="tooltip" data-bs-original-title="{{ __('Broadcast') }}">
                    ...
                    $unseenCounter = App\Models\Notification::where('company_id', '<>', null)
                        ...
                        <li class="dropdown dash-h-item drp-notification">
                            <a class="dash-head-link dropdown-toggle arrow-none me-0 " data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false" id="msg-btn-sp">
                                ...
                                <span class="bg-danger dash-h-badge message-counter ">{{ $unseenCounter }}
                            ...
                            <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                                <div class="noti-header">
                                    ...
                                    <a href="#" class="cursor-pointer" onclick="checkAllSeen()">{{ __('Clear All') }}</a>
                                </div>
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="dropdown dash-h-item drp-notification">
                        <a class="dash-head-link dropdown-toggle arrow-none me-0 " data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false" id="msg-btn">
                            <i class="ti ti-message-2"></i>
                            <span class="bg-danger dash-h-badge message-counter custom_messanger_counter">{{ $unreadCounter }}
                                <span class="sr-only"></span>
                            </span>
                        </a>
                        <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                            ...
                            <div class="noti-footer">
                                <div class="d-grid">
                                    <a href="{{ route('chats') }}" class="mx-0 btn dash-head-link justify-content-center text-primary">View all</a>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="dropdown dash-h-item drp-language">
                        ...
                        <a href="{{ route('change.language', $lang) }}"
                            ...
                            <a href="{{ route('change.language', $code) }}" class="dropdown-item {{ $currantLang == $code ? 'text-primary' : '' }}">
                                <span>{{ ucFirst($lang) }}</span>
                            </a>
                            @endforeach
                            @if (\Auth::user()->type == 'super admin')
                            <div class="m-0 dropdown-divider"></div>
                            <a href="#" class="dropdown-item text-primary" data-size="md" data-url="{{ route('create.language') }}" data-ajax-popup="true" data-title="{{ __('Create New Language') }}" data-bs-toggle="tooltip">{{ __('Create Language') }}</a>
                            <div class="m-0 dropdown-divider"></div>
